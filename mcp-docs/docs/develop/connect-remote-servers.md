...
## [Build your own remote serverCreate custom remote MCP servers to integrate with proprietary tools and services](https://support.anthropic.com/en/articles/11503834-building-custom-connectors-via-remote-mcp-servers)## [Explore available serversBrowse our collection of official and community-created MCP servers](https://github.com/modelcontextprotocol/servers)## [Connect local serversLearn how to connect Claude Desktop to local MCP servers for direct system access](/docs/develop/connect-local-servers)## [Understand the architectureDive deeper into how MCP works and its architecture](/docs/learn/architecture)
